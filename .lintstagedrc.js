module.exports = {
  ...
  "*.{ts,tsx,js,jsx}": [
    // 1. ESLint 检查并自动修复（严格模式：零警告）| ESLint check and auto-fix (strict mode: zero warnings)
    // "eslint --fix --max-warnings 0",
    "eslint --fix",
    // --fix: 自动修复可修复的问题 | Auto-fix fixable issues
    // --max-warnings 0: 任何警告都会导致失败 | Any warning will cause failure
  ...
  ".{gitignore,prettierignore,eslintignore}": [
    // Prettier 格式化忽略文件 | Format ignore files with Prettier
    "prettier --write",
  ],
